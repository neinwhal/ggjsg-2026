...
# enemy stats
@export var enemy_HP: float = 20
@export var enemy_HP_max: float = 20
@export var speed : float = 80.0
@export var gravity : float = 1200.0
@export var detect_range : float = 500.0
@export var attack_cooldown : float = 1.2 # time between attacks
@export var do_splash_dmg : bool = false
@export var attack_damage_min : int = 3 # damage dealt
